...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of( "http://localhost:3000",  // Local development
                "https://examportal-frontend-165510053390.asia-south2.run.app")); // Allow frontend origin
